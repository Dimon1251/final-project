...
Route::group(['middleware' => ['auth:admin']], function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::post('/users/{id}/edit', [App\Http\Controllers\AdminController\UserController::class, 'edit'])->name('admin.users.edit');
        ...
        Route::delete('/products/{id}', [App\Http\Controllers\AdminController\ProductController::class, 'destroy'])->name('admin.products.destroy');
        Route::post('/products/create', [App\Http\Controllers\AdminController\ProductController::class, 'create'])->name('admin.products.create');
        ...
        Route::post('/categories/{id}/edit', [App\Http\Controllers\AdminController\CategoryController::class, 'edit'])->name('admin.categories.edit');
        ...
        Route::delete('/categories/{id}', [App\Http\Controllers\AdminController\CategoryController::class, 'destroy'])->name('admin.categories.destroy');
        Route::post('/categories/{id}/restore', [App\Http\Controllers\AdminController\CategoryController::class, 'restore'])->name('admin.categories.restore');
        Route::post('/categories/create', [App\Http\Controllers\AdminController\CategoryController::class, 'create'])->name('admin.categories.create');
        ...
        Route::post('/brands/{id}/edit', [App\Http\Controllers\AdminController\BrandController::class, 'edit'])->name('admin.brands.edit');
        Route::put('/brands/{id}', [App\Http\Controllers\AdminController\BrandController::class, 'update'])->name('admin.brands.update');
        Route::delete('/brands/{id}', [App\Http\Controllers\AdminController\BrandController::class, 'destroy'])->name('admin.brands.destroy');
        Route::post('/brands/{id}/hide', [App\Http\Controllers\AdminController\BrandController::class, 'hide'])->name('admin.brands.hide');
        Route::post('/brands/{id}/unhide', [App\Http\Controllers\AdminController\BrandController::class, 'unhide'])->name('admin.brands.unhide');
        Route::post('/brands/create', [App\Http\Controllers\AdminController\BrandController::class, 'create'])->name('admin.brands.create');
