                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.products.update', $product->id) }}" method="post" enctype="multipart/form-data" >
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter the name" value="{{ $product->name }}"><br>
                                    <label class="form-label">Description</label>
                                    <textarea rows="10" class="form-control" name="description" placeholder="Enter the description">{{ $product->description }}</textarea><br>
                                    <label class="form-label">Price</label>
                                    <input type="number" class="form-control" name="price" placeholder="Enter the price" value="{{ $product->price }}"><br>
                                    <div class="mb-3">
